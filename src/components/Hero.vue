<template>
    <div class="hero mr-4 ml-4 pt-[120px] pb-[180px] rounded-[16px]">
        <div class="flex flex-col pl-[80px]">
            ...
            <a href="#" class="w-[180px] flex justify-center items-center border-1 border-[#FF921C] bg-[#FF921C] text-white mont-medium text-[18px] rounded-[200px] pt-4 pb-4 pr-8 pl-8 transform hover:-translate-y-1 hover:shadow-[0_0_15px_5px_rgba(255,146,28,0.5)] transition-all duration-200">Каталог</a>
        </div>
    </div>
</template>
